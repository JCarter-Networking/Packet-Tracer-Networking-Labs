...
This collection contains networking labs that I have created, completed, and refined over time to reinforce key networking concepts.

Each lab is designed with a specific learning objective, which is outlined at the beginning of the lab.

Some labs include accompanying documentation detailing challenges encountered, troubleshooting steps, "what-if" scenarios I explored, investigative processes, results, and conclusions. These notes document both my learning process and my approach to problem-solving.
